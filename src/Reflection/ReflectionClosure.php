...
namespace Hail\Serializer\Reflection;
...
class ReflectionClosure extends ReflectionFunction
{
    ...
    private $isStaticClosure;
    private $isScopeRequired;
    private $isBindingRequired;
    ...
    public function isStatic(): bool
    {
        if ($this->isStaticClosure === null) {
            $this->isStaticClosure = stripos($this->getCode(), 'static') === 0;
        }
    ...
    public function getCode(): string
    {
        ...
        switch (PHP_MINOR_VERSION) {
            ...
            case 2:
            default:
                $php7_types = ['string', 'int', 'bool', 'float', 'void', 'object'];
        }
                ...
                case 'closure':
                    switch ($token[0]) {
                        ...
                        case T_COMMENT:
                            ...
                            break;
                        case T_VARIABLE:
                            if (!$inside_anonymous && $token[1] === '$this') {
     ...
     * @return array
     */
    private function getFileTokens(): array
    {
                    ...
                    switch ($token[0]) {
                        ...
                        case T_TRAIT:
                            ...
                            if ($token[0] === T_CLASS) {
                                ...
                                $structType = $token[0] === T_INTERFACE ? 'interface' : 'trait';
                            }
                            break;
                        case T_USE:
                            $state = 'use';
